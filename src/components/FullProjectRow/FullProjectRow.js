...
function FullProjectRow() {
    return (
        <ProjectContainer>
            <Project>
                <ProjectImage />
                <SubHeading>MultiMedia E-Commerce</SubHeading>
                <ProjectParagraph>
                    My current work in progress, a web application using microfrontends
                    that divide a monolithic app into multiple sub-apps and help teams 
